...
const translations = {
    en: {
        ...
        projects: {
            ...
            yasaminType: "Digital Menu",
            yasaminTitle: "Yasamin Menu",
            yasaminDesc: "A modern digital menu for restaurants and cafes with QR code integration.",
    ...
    ar: {
        ...
        projects: {
            ...
            yasaminType: "القائمة الرقمية",
            yasaminTitle: "قائمة ياسمين",
            yasaminDesc: "قائمة رقمية حديثة للمطاعم والمقاهي مع تكامل رمز QR.",
    ...
    ku: {
        ...
        projects: {
            ...
            yasaminType: "مێنیوی دیجیتاڵی",
            yasaminTitle: "مێنیوی یاسمین",
            yasaminDesc: "مێنیوی دیجیتاڵی مۆدێرن بۆ ڕێستۆرانت و کافێ بە تێکەڵکردنی کۆدی QR.",
